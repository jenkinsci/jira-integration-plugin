		...
		extends GlobalConfiguration
{
	...
	private StringCredentials createSharedSecretCredentials(JiraSite site)
	{
		...
		return new StringCredentialsImpl(CredentialsScope.GLOBAL, UUID.randomUUID().toString(), description,
	...
	{
		return sites.stream().filter(site -> site.getUri().equals(uri)).findFirst();
	}
